...
wind_multiplier = [1, 5, 10]  # во сколько раз увеличить модельную (равномерную по 4-м странам) генерацию ветра √ермании. ѕервое значение дл€ первого сценари€ и т. д.
solar_multiplier = [1, 5, 10]  # во сколько раз увеличить реальную генерацию солнца √ермании
capacity_storage = [1001, 2000, 3000]  # Ёмкость аккумуляции в ГВт*ч. 1300 ГВт*ч эквивалентно суточному потреблению.
